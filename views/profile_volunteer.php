<?php
$userData = include_once '../controllers/fetch_user_data_volunteer.php'; // Include the PHP file and fetch the user data array
?>
...
<head>
    ...
    <link rel="stylesheet" href="../styles/profile_volunteer.css"> <!-- Link to the CSS file -->
</head>
<body>
